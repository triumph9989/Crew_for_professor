...
const Crew_3 = class Crew_3 {
    constructor(c_id, tid, crew_name, car, crew_img, car_img) {
        this.c_id = c_id;
        this.tid = tid;
    ...
    static create(req, res) {
        ...
        return db.execute(
            'INSERT INTO c (c_id, tid, crew_name, car, crew_img, car_img) VALUES (?, ?, ?, ?, ?, ?)',
            [
                req.body.c_id,
                req.body.tid,
                req.body.crew_name,
    ...
    static updateById(req, res) {
        ...
        return db.execute(
            'UPDATE c SET crew_name = ?, tid = ? , car = ? , crew_img = ? , car_img = ? WHERE c_id = ?',
            [crew_name, tid, car, crew_img, car_img, c_id]
        );
    }
    // DELETE
